...
public class Vec3 {
    ...
    public double x, y, z;
    private double length = Double.NEGATIVE_INFINITY;
    ...
    public double length() {
        if (this.length == Double.NEGATIVE_INFINITY)
            this.length = 1 / Functions.fastInverseSqrt(this.x * this.x + this.y * y + this.z * this.z);
        return this.length;
    }

    public Vec3 get_normalized() {
        double len = Functions.fastInverseSqrt(this.x * this.x + this.y * y + this.z * this.z);
